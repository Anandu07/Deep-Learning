...
def get_model(input_shape):
    ...
    """
    model = Sequential([Dense(64,kernel_initializer='he_uniform',bias_initializer='ones',activation='relu',input_shape=input_shape),
...
def get_regularised_model(input_shape, dropout_rate, weight_decay):
    ...
    Your function should return the model.
    """
    model = Sequential([Dense(64,kernel_initializer='he_uniform',bias_initializer='ones',kernel_regularizer=regularizers.l2(weight_decay),activation='relu',input_shape=input_shape),
